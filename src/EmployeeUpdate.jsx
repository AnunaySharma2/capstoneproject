        ...
        <div className={styles.container}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className={styles.form_group}>
                    ...
                    <input className={"text-white bg-gray-900 border-none my-2"} type="text" value={name} onChange={(e) => setName(e.target.value)}/>
                </div>
                <div className={styles.form_group}>
                    <label>Update Branch:</label>
                    <input className={"text-white bg-gray-900 border-none my-2"} type="text" value={dept} onChange={(e) => setDept(e.target.value)}/>
                </div>
                <div className={styles.form_group}>
                    <label>Update Photo URL:</label>
                    <input className={"text-white bg-gray-900 border-none my-2"} type="text" value={photoURL} onChange={(e) => setPhotoURL(e.target.value)}/>
                </div>
                <div className="mb-4">
